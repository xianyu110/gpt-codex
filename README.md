...
但拿它做开放式创作、泛知识问答、复杂事实核查，它未必是最理想的选手。这不是缺点，而是定位问题。

![图片](https://upload.maynor1024.live/file/1774358257887_image.png#imgIndex=8)

### 1.4 GPT-5.4 补充说明（基于 OpenAI 官方信息）

如果你只看 README，很容易得到一个印象：**Codex = GPT-5.3-codex**。

但在 **2026-03-05**，OpenAI 官方已经发布了 **GPT-5.4**，定位是：
...
- 在 Codex 里有 **实验性的 100 万上下文窗口版本**，适合更复杂、更长链路的工程任务

你今天再理解 Codex，不能只停留在"纯编程特化工具"，更准确的理解应该是：
...
> ⚠️ **以上为 README 当前写法，不代表未来套餐配置不会变化。** GPT-5.4 已在 2026-03-05 发布，具体哪个套餐可用什么模型，以 **OpenAI 官方页面**和**你账号里的实际模型列表**为准。
